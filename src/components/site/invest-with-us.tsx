    ...
    >
      <Container>
        ...
        <RevealGroup className="mt-16 grid gap-6 sm:grid-cols-2" stagger={0.15}>
          {/* Panel 1: Founders */}
          <RevealItem>
            <SpotlightCard className="h-full rounded-xl border border-border bg-card transition-colors duration-500 hover:border-accent/40">
              <div className="flex h-full flex-col justify-between p-10 sm:p-14">
                <div>
                  <h4 className="text-[0.65rem] font-bold tracking-[0.2em] text-accent uppercase">
                    For Founders
                  </h4>
                  ...
                  <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
                    Get the positioning, story and reach you need to attract the
                    right funding and customers.
                  </p>
                </div>
                <div className="mt-12">
                  <Link
          ...
          <RevealItem>
            <SpotlightCard className="h-full rounded-xl border border-border bg-surface transition-colors duration-500 hover:border-accent/40">
              <div className="flex h-full flex-col justify-between p-10 sm:p-14">
                <div>
                  <h4 className="text-[0.65rem] font-bold tracking-[0.2em] text-accent uppercase">
                  ...
                  <h3 className="mt-6 font-display text-3xl text-foreground">
                    Co-invest in visibility.
                  </h3>
                  <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
                    Partner with us on investor-readiness programmes, media
                    partnerships and ecosystem sponsorships.
                  </p>
                </div>
                <div className="mt-12">
                  <Link
